...
CREATE TABLE MESSAGE(
    ...
    RECV_NICKNAME VARCHAR2(100) NOT NULL,
    GUBUN NUMBER DEFAULT '0',
    CREATE_DATE DATE NOT NULL,
    MSG_CONTENT VARCHAR2(500) NOT NULL,
    SEND_NICKNAME VARCHAR2(100) NOT NULL,
    EMAIL VARCHAR2(100) PRIMARY KEY,
    READ_YN NUMBER DEFAULT '0',
    
    CONSTRAINT MSG_EMAIL FOREIGN KEY(EMAIL) REFERENCES MEMBER (EMAIL),
    CONSTRAINT MSG_RECV_NICK FOREIGN KEY (RECV_NICKNAME) REFERENCES MEMBER (NICKNAME),
    CONSTRAINT MSG_SEND_NICK FOREIGN KEY (SEND_NICKNAME) REFERENCES MEMBER (NICKNAME)
...
>>>>>>> f23d80ad8317384c154ee2dcda39e7467e0e3565

--9/14 수정
ALTER TABLE AUCTION ADD COLUMN HIGH_BIDDER VARCHAR2(100);
COMMIT;
